...
@interface JobDetailScreen : UIViewController {
	UIButton *__cmdAddJobBid;
	UIButton *__cmdUserPostingButton;
	UIButton *__cmdViewJobBids;
...
@property (nonatomic, retain) IBOutlet UIButton *_cmdAddJobBid;

@property (nonatomic, retain) IBOutlet UIButton *_cmdUserPostingButton;

@property (nonatomic, retain) IBOutlet UIButton *_cmdViewJobBids;
...
- (IBAction)AddJobBidClicked:(id)sender;

- (IBAction)ViewJobBidsClicked:(id)sender;
